										...
										<ul class="pagination justify-content-center"
											...
											<c:if test="${adpageMaker.prev }">
												<li class="page-item"><a class="page-link"
													href="Udo_Attraction?pageNum=${adpageMaker.adStartPage -1 }">Previous</a></li>
											</c:if>
											<!-- 2. 페이지번호 활성화 여부 -->
											<c:forEach var="num" begin="${adpageMaker.adStartPage }"
												...
												<li
													...
													class="page-link" href="Udo_Attraction?num1=18&count_oracle=${adcri.count_oracle}&adpageStart=${adcri.adpageStart}&pageNum=${num }">${num }</a></li>
											</c:forEach>
											<!-- 3. 다음 버튼 활성화 여부 -->
											<c:if test="${adpageMaker.next }">
												<li class="page-item"><a class="page-link"
													href="Udo_Attraction?pageNum=${adpageMaker.adEndPage +1 }">Next</a></li>
											</c:if>
										</ul>
									</div>
								</div>
