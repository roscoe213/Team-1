										...
										<div class="card-body">
											...
											<div class="form-group">
												...
												<textarea class="form-control" rows="10"
													style="height: 350px; font-size: 25px; resize: none;"
											...
											<form name="readForm" role="form" method="post">
												...
												<div class="form-group"
													style="border: 1px solid #dbdbdb; display: inline;">
											...
											<c:choose>
												<c:when
													test="${sessionScope.user_email == null || board.writer != sessionScope.user_nick }">
													<button type="button" class="btn btn-dark"
														style="float: right;"
														onclick="location.href='list?pageNum=${cri.pageNum}&count=${cri.count }'">목록</button>
												</c:when>
												<c:otherwise>
													<button type="button" class="btn btn-primary"
														style="float: right; margin-left: 20px;"
														onclick="location.href='modify?num=${board.bno}&pageNum=${cri.pageNum}&count=${cri.count }'">수정</button>
													<button type="button" class="btn btn-dark"
														style="float: right;"
														onclick="location.href='list?pageNum=${cri.pageNum}&count=${cri.count }'">목록</button>
					...
					<c:forEach var="articles" items="${top_list }">
						...
						<section>
							<div class="row gtr-100">
								<div class="col-4">
									<a href="#" class="image fit" style="margin-bottom: 50px;"><img
										src="${pageContext.request.contextPath}/images/food/해조네.jpg"
										alt="" /></a>
								</div>
								<div class="col-8">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<button id="addReplyBtn"
								class="btn btn-primary btn-sm pull-right">New Reply</button>
						</div>
									...
									<div>
										<div class="header">
											<strong class="primary-font">user00</strong> <small
												class="pull-right text-muted">2022-09-29 11:22</small>
										</div>
										<p>Good job!</p>
									</div>
								</li>
						...
						<div class="modal-body">
							...
							<div class="form-group">
								<label>Replyer</label> <input class="form-control"
									name="writer" id="writer" value="${sessionScope.user_nick }" readonly >
							</div>
